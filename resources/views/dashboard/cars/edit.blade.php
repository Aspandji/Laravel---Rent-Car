...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/dashboard/cars/{{ $car->slug }}" method="POST" enctype="multipart/form-data" class="mb-5">
            @method('put')
            @csrf
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('car_code') is-invalid @enderror" id="car_code"
                    name="car_code" placeholder="Code Mobil" required autofocus
                    value="{{ old('car_code', $car->car_code) }}">
                @error('car_code')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                    name="title" placeholder="Nama Mobil" required autofocus value="{{ old('title', $car->title) }}">
                @error('title')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                @if ($car->image)
                    <img src="{{ asset('storage/' . $car->image) }}" class="img-preview img-fluid mb-3 d-block col-sm-5"
